...
\\
dsnyder@cs.utexas.edu \textbullet
...
\begin{itemize}
	...
	\begin{itemize*}
		\item Implemented repeatable workflows for processing large datasets using a variety of technologies
                  including Hadoop/MapReduce with Apache Pig and Hadoop streaming.
		\item Coded and deployed Ruby on Rails web applications in a production environment.
                \item Built a publishing pipeline to streamline the process of uploading large datasets to HBase, ElasticSearch, and MySQL databases.
